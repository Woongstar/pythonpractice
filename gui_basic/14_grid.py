...
#Top line
btn_f_16 = Button(root, text="f16",width=5,height=2)
btn_f_17 = Button(root, text="f17",width=5,height=2)
btn_f_18 = Button(root, text="f18",width=5,height=2)
btn_f_19 = Button(root, text="f19",width=5,height=2)
btn_f_16.grid(row=0,column=0, sticky=N+E+W+S,padx=3,pady=3)
btn_f_17.grid(row=0,column=1, sticky=N+E+W+S,padx=3,pady=3)
btn_f_18.grid(row=0,column=2, sticky=N+E+W+S,padx=3,pady=3)
btn_f_19.grid(row=0,column=3, sticky=N+E+W+S,padx=3,pady=3)
